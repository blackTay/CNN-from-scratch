"""
Author: Tassilo Schwarz, Sophia Sanborn
...
class Dataset:
    ...
    def preprocess(self): # normalize the data
        self.train.data_ = (preprocessing.StandardScaler().fit(self.train.data_)).transform(self.train.data_)
        self.validate.data_ = (preprocessing.StandardScaler().fit(self.validate.data_)).transform(self.validate.data_)
