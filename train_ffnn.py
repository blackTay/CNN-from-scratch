...
fc1 = AttrDict(
    {
        ...
        "n_out": 10, # me: change this for 5.2; it's size of hidden layer (first layer)
    }
)
...
optimizer_args = AttrDict(
    {
        "name": "SGD",
        "lr": 0.0001, # me: change this for 5.2
...
dataset.preprocess() # own function: normalize the data
